...
/**
 * The {@link MethodEntryPointProbeInterceptor} represents a static interceptor of method entry point probe.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public class MethodEntryPointProbeInterceptor extends StaticInterceptor {
    public static IInterceptor interceptor;

    public static Object onEnter(int index, int version, Object instance, Object[] params) {
        IInterceptor interceptor = MethodEntryPointProbeInterceptor.interceptor;
