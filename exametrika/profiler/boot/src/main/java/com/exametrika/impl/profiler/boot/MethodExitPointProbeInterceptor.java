...
/**
 * The {@link MethodExitPointProbeInterceptor} represents a static interceptor of method exit point probe.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public class MethodExitPointProbeInterceptor extends StaticInterceptor {
    public static IInterceptor interceptor;

    public static Object onEnter(int index, int version, Object instance, Object[] params) {
        IInterceptor interceptor = MethodExitPointProbeInterceptor.interceptor;
