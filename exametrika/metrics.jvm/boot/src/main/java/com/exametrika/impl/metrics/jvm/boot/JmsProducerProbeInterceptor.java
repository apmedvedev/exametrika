...
/**
 * The {@link JmsProducerProbeInterceptor} represents a static interceptor of JMS producer probe.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public class JmsProducerProbeInterceptor extends StaticInterceptor {
    public static IInterceptor interceptor;

    public static Object onEnter(int index, int version, Object instance, Object[] params) {
        IInterceptor interceptor = JmsProducerProbeInterceptor.interceptor;
