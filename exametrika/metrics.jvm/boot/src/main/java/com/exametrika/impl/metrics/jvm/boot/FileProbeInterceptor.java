...
/**
 * The {@link FileProbeInterceptor} represents a static interceptor of file probe.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public class FileProbeInterceptor extends StaticInterceptor {
    public static IInterceptor interceptor;

    public static Object onEnter(int index, int version, Object instance, Object[] params) {
        IInterceptor interceptor = FileProbeInterceptor.interceptor;
