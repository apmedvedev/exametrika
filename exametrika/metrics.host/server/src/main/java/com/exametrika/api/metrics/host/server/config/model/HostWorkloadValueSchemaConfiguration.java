...
/**
 * The {@link HostWorkloadValueSchemaConfiguration} is a host workload value schema configuration.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public final class HostWorkloadValueSchemaConfiguration extends ObjectValueSchemaConfiguration {
    private final String baseRepresentation;

    public HostWorkloadValueSchemaConfiguration(String name, String baseRepresentation) {
        super(name);
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof HostWorkloadValueSchemaConfiguration))
            return false;

        HostWorkloadValueSchemaConfiguration configuration = (HostWorkloadValueSchemaConfiguration) o;
