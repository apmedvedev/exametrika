...
import com.exametrika.impl.metrics.host.server.values.HostWorkloadAccessor.Type;
...
/**
 * The {@link HostWorkloadAccessorFactory} is a host workload metric accessor factory.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public final class HostWorkloadAccessorFactory implements IMetricAccessorFactory {
    ...
    public HostWorkloadAccessorFactory(HostWorkloadRepresentationSchemaConfiguration configuration,
    ...
    public IMetricAccessor createAccessor(String navigationType, String navigationArgs, String fieldName) {
        return new HostWorkloadAccessor(getType(fieldName), new HostWorkloadComputer(configuration, componentAccessorFactory,
