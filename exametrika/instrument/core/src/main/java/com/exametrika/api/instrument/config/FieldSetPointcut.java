...
/**
 * The {@link FieldSetPointcut} represents a field set pointcut.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public final class FieldSetPointcut extends Pointcut {
     ...
     */
    public FieldSetPointcut(String name, QualifiedMethodFilter methodFilter,
    ...
    public IInstrumentor createInstrumentor(IInterceptorAllocator interceptorAllocator, String className, String methodName,
        ...
        return new FieldSetInstrumentor(this, interceptorAllocator, className, methodName, methodSignature, overloadNumber,
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof FieldSetPointcut))
            return false;

        FieldSetPointcut pointcut = (FieldSetPointcut) o;
