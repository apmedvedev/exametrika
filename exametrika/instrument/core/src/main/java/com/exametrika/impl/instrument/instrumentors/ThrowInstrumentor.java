...
/**
 * The {@link ThrowInstrumentor} represents a method throw exception instrumentor.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are not thread safe.
 */
public final class ThrowInstrumentor extends AbstractInstrumentor {
    private final ThrowPointcut pointcut;

    public ThrowInstrumentor(ThrowPointcut pointcut, IInterceptorAllocator interceptorAllocator, String className, String methodName,
    ...
    @Override
    public void onThrow() {
        JoinPointInfo info = allocateInterceptor(IJoinPoint.Kind.THROW, pointcut, null, null, null);
        if (info == null)
            return;
        ...
        generator.invokeStatic(Type.getType(getInterceptorClass(pointcut)), Method.getMethod("void onThrow(int, int, java.lang.Object, java.lang.Throwable)"));
    }
}
