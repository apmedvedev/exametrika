...
/**
 * The {@link StackAccessor} is an accessor of fields in stack metric type.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public final class StackAccessor implements IMetricAccessor {
    private final boolean inherent;
    private final IFieldAccessor childAccessor;
    private final boolean opposite;

    public StackAccessor(boolean inherent, IFieldAccessor childAccessor, boolean opposite) {
