...
/**
 * The {@link HealthIndexAccessor} is an implementation of {@link IFieldAccessor} for health index.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are not thread safe.
 */
public final class HealthIndexAccessor implements IMetricAccessor {
    public enum Type {
        STATE,
        CAUSES
    }
    ...
    private final HealthIndexComputer computer;

    public HealthIndexAccessor(Type type, HealthIndexComputer computer) {
        Assert.notNull(type);
