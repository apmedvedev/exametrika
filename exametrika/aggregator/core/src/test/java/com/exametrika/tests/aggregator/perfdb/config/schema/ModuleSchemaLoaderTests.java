 ...
 */
package com.exametrika.tests.aggregator.perfdb.config.schema;
...
public class ModuleSchemaLoaderTests {
    ...
    public static class TestPeriodNodeSchemaConfiguration extends PeriodNodeSchemaConfiguration {
        public TestPeriodNodeSchemaConfiguration(String name, String alias, String description, IndexedLocationFieldSchemaConfiguration primaryField,
                                                 List<? extends FieldSchemaConfiguration> fields) {
        ...
        public boolean equals(Object o) {
            if (o == this)
                return true;
            if (!(o instanceof TestPeriodNodeSchemaConfiguration))
                return false;

            TestPeriodNodeSchemaConfiguration configuration = (TestPeriodNodeSchemaConfiguration) o;
            return super.equals(configuration);
        }

        @Override
        public boolean equalsStructured(NodeSchemaConfiguration newSchema) {
            if (!(newSchema instanceof TestPeriodNodeSchemaConfiguration))
                return false;

            TestPeriodNodeSchemaConfiguration configuration = (TestPeriodNodeSchemaConfiguration) newSchema;
    ...
    public static class TestSchemaConfigurationLoader extends AbstractExtensionLoader {
        ...
        public Object loadExtension(String name, String type, Object object, ILoadContext context) {
            ...
            if (type.equals("TestDomainService"))
            ...
            } else if (type.equals("TestPeriodNode")) {
                String alias = element.get("alias", name);
                String description = element.get("description", null);
                ...
                IndexedLocationFieldSchemaConfiguration primaryField = load("primaryField", "IndexedLocationField", element.get("primaryField"), context);

                return new TestPeriodNodeSchemaConfiguration(name, alias, description, primaryField, fields);
    ...
    private void checkModules(Collection<ModuleSchemaConfiguration> modules, String timeZone) {
        ...
        IndexFieldSchemaConfiguration field25 = new IndexFieldSchemaConfiguration("field25", new HashIndexSchemaConfiguration("index3",
                ...
                new FixedCompositeKeyNormalizerSchemaConfiguration(Arrays.asList(new LocationKeyNormalizerSchemaConfiguration())))),
        ...
        PeriodSpaceSchemaConfiguration space2 = new PeriodSpaceSchemaConfiguration("space2", "space2", null,
                Arrays.asList(new PeriodSchemaConfiguration("period1", "period1", null, Collections.<PeriodNodeSchemaConfiguration>asSet(
                        new TestPeriodNodeSchemaConfiguration("root", "root", null,
                                new IndexedLocationFieldSchemaConfiguration("primaryField", "primaryField", null, 1),
                                Arrays.<FieldSchemaConfiguration>asList())), "root", "root",
                                new StandardSchedulePeriodSchemaConfiguration(UnitType.SECOND, Kind.RELATIVE, 1, timeZone), 1, true, null),
                        new PeriodSchemaConfiguration("period2", "period2", null, new HashSet(),
                                null, null, new StandardSchedulePeriodSchemaConfiguration(UnitType.SECOND, Kind.RELATIVE, 2, timeZone), 20, false, null)), 1, 2);
        DatabaseSchemaConfiguration schema = new DatabaseSchemaConfiguration("module1", "module1", null, Collections.asSet(
                new DomainSchemaConfiguration("domain1", "domain1", null, Collections.<SpaceSchemaConfiguration>asSet(space1, space2),
                        Collections.<DomainServiceSchemaConfiguration>asSet(new TestDomainServiceSchemaConfiguration()))),
                java.util.Collections.singleton(new PeriodDatabaseExtensionSchemaConfiguration(new NameSpaceSchemaConfiguration(
                        "nameSpace", 1, 2, 3))));
