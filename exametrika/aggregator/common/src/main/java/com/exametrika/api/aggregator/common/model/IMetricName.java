...
/**
 * The {@link IMetricName} represents a structured metric name, consisting of a hierarchical domain consisting of a list of segments.
 * <p>
 ...
 */
public interface IMetricName extends IMetricLocation {
    /**
     * Is name empty?
     *
     ...
     */
    boolean startsWith(IMetricName prefix);
}
