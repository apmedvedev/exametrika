...
/**
 * The {@link HashIndexStatistics} is an in-memory hash index statistics.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are thread safe.
 */
public final class HashIndexStatistics {
    ...
    public HashIndexStatistics(long elementCount, long pageCount, long dataSize, double usage, double elementsPerPage,
