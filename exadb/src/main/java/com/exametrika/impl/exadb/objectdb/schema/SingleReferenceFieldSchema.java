...
/**
 * The {@link SingleReferenceFieldSchema} is a single reference field schema.
 *
 * @author Medvedev-A
 * @threadsafety This class and its methods are not thread safe.
 */
public class SingleReferenceFieldSchema extends SimpleFieldSchema implements IReferenceFieldSchema {
    ...
    public SingleReferenceFieldSchema(SingleReferenceFieldSchemaConfiguration configuration, int index, int offset) {
        super(configuration, index, offset);
    }

    @Override
    public SingleReferenceFieldSchemaConfiguration getConfiguration() {
        return (SingleReferenceFieldSchemaConfiguration) configuration;
    }
    ...
    public void resolveDependencies() {
        ...
        SingleReferenceFieldSchemaConfiguration configuration = getConfiguration();
    ...
    public IFieldObject createField(IField field) {
        return new SingleReferenceField((ISimpleField) field);
    }

    @Override
    public void validate(IField field) {
        if (getConfiguration().isRequired()) {
            ISingleReferenceField refField = field.getObject();
