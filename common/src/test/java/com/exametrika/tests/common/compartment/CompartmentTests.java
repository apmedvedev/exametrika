...
public class CompartmentTests {
    ...
    public void testTimer() {
        TestTimerHandler handler = new TestTimerHandler();
        ICompartmentTimer timer = new CompartmentTimer(handler);
        timer.onTimer(100);
        assertThat(handler.counter, is(0L));
        assertThat(timer.getAttempt(), is(0));
        ...
        timer.onTimer(100);
        assertThat(handler.counter, is(1L));
        assertThat(timer.getAttempt(), is(1));
        ...
        timer.onTimer(200);
        assertThat(handler.counter, is(2L));
        assertThat(timer.getAttempt(), is(2));
        ...
        timer.onTimer(300);
        assertThat(handler.counter, is(3L));
        assertThat(timer.getAttempt(), is(3));
        ...
        timer.onTimer(1000);
        assertThat(handler.counter, is(4L));
        assertThat(timer.getAttempt(), is(4));
    ...
    private static class TestTimerHandler implements ICompartmentTimerProcessor {
