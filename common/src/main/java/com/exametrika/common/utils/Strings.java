...
public final class Strings {
     ...
     * @throws InvalidArgumentException if indent or width <= 0
     */
     ...
     * @return string
     */
    public static <T> String toString(Iterable<T> collection, boolean indent) {
    ...
    /**
     * Converts collection to string, making each element separated by given separator.
     *
     * @param <T>        collection type
     * @param collection collection
     * @param start start
     ...
     * @return string
     */
    public static <T> String toString(Iterable<T> collection, String start, String separator, String end) {
        Assert.notNull(collection);
        String result = toString(collection, separator);
        if (!result.isEmpty())
