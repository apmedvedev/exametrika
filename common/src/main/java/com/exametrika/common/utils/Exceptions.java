...
public final class Exceptions {
     ...
     * @throws T if specified exception contains application exception, else throws original exception
     */
     ...
     * @param e      system exception
     * @throws T1, T2 if specified exception contains application exception, else throws original exception
     */
