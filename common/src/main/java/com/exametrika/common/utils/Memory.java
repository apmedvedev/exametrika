...
public final class Memory {
    private static final long directMemory;
    static {
        directMemory = initDirectMemory();
    }
    ...
    private static long initDirectMemory() {
        Class clazz;
        try {
            clazz =Classes.forName("sun.utils.VM");
        } catch (Exception e) {
            clazz = Classes.forName("jdk.internal.misc.VM");
        }
