...
public final class BitArray {
     ...
     * @param length length of bit array in bits
     * @throws InvalidArgumentException if length != (length >>> ADDRESS_BITS_PER_WORD) + 1
     */
     ...
     * @throws InvalidArgumentException if array length is not equal to length of this array
     */
