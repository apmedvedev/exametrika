...
public final class Serialization extends DataSerialization implements ISerialization {
    ...
    private TObjectIntMap<Object> identityMap = null;
    ...
    public void writeObject(Object value) {
        if (value != null) {
            if (stack.preserveIdentity) {
                if (identityMap == null)
                    identityMap = new TObjectIntCustomHashMap<Object>(new IdentityHashingStrategy<Object>(), 10, 0.5f, Integer.MAX_VALUE);
