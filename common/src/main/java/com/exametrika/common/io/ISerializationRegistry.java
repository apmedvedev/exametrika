...
public interface ISerializationRegistry {
     ...
     * @throws InvalidArgumentException if serialization info is not found
     */
     ...
     * @throws InvalidArgumentException if id or serializableClass being registered are not unique in this registry
     */
